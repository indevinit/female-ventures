...
//             isLoggedIn:true            
        ...
        axios.get('https://femaleventures-server.herokuapp.com/api/users/getAllUsers')
    ...
    <div className="dashboard" >
      ...
      <br/>
        ...
        <div className="row">
            ...
            <br/> 
            <br/> 
            <img src="https://avatars1.githubusercontent.com/u/38748551?s=400&v=4" style={imageStyle} className="rounded-circle" alt="selliepict"></img>
            </div>
          </div>
          <br/>
          <div className="row">
