                ...
                <div className="row"> {/* Begin of first row */}
                    ...
                    <br/>
                        <div className="row"> {/* Begin of second row */}
                            ...
                            <img src="https://images.unsplash.com/photo-1525078603777-7525bc242652?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=579&q=80" style={imageStyle} className="img-rounded" alt="event1"></img>
                            ...
                            <div className="col-md-4">
                            <img src="https://images.unsplash.com/photo-1535448606533-07a2789ef57e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=848&q=80" style={imageStyle} className="img-rounded" alt="event1"></img>
                            ...
                            <div className="col-md-4">
                            <img src="https://images.unsplash.com/photo-1507890512529-4b15a5a02988?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" style={imageStyle} className="img-rounded" alt="event1"></img>
