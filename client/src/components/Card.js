...
class Card extends Component {
  ...
  onClick = e => {
    ...
    if (e.target.name === "logout") {
      axios.get(`https://femaleventures-server.herokuapp.com/api/users/logout`).then(res => {
        this.props.history.push("/");
      });
    }

    if (e.target.name === "profile") {
      axios.get(`https://femaleventures-server.herokuapp.com/api/users/profile`).then(res => {
