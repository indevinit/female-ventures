...
class ChallengeForm extends Component {
  ...
  componentWillMount() {
    axios
      .get("https://femaleventures-server.herokuapp.com/api/users/authorization")
      .then(res => {
  ...
  getAll = () => {
    axios.get("https://femaleventures-server.herokuapp.com/api/challenges/all").then(res => {
      console.log(res);
  ...
  onSubmit = e => {
    ...
    e.preventDefault();
    axios
      .post("https://femaleventures-server.herokuapp.com/api/challenges/add", this.state.formData)
      .then(res => {
        this.props.history.push("/challenges");
        this.getAll();
      })
